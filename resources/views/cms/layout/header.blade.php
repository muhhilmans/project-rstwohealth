        ...
        <nav class="navbar navbar-expand align-items-center gap-4">
            ...
            <div class="search-bar flex-grow-1">
                <div class="position-relative">
                    <input class="form-control rounded-5 px-5 search-control d-none" type="text"
                        placeholder="Search">
                    <span
                        class="material-icons-outlined position-absolute d-none ms-3 translate-middle-y start-0 top-50">search</span>
                    <span
            ...
            <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
                        <img src="{{ asset('dashboard/assets/images/avatars/01.png') }}" class="rounded-circle p-1 border" width="45"
                            height="45" alt="">
                    </a>
